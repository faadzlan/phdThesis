...
\begin{figure} \continuedfloat
  ...
  \caption{The cruciform variations studied in this thesis (continued from previous page.)}\label{fig:cruciformLayouts}
...
\begin{figure} \continuedfloat
  ...
  \caption{The course, medium and fine mesh used in the grid independency study (continued from previous page.)} \label{fig:convergenceStudy}
...
\begin{figure} \continuedfloat
  ...
  \caption{Temporal analysis of Cl and $\ystr$ at $\ured = \urtw$ (continued from previous page.)} \label{fig:tempAnalysisKVIV}
% Temporal analysis of the lift coefficient and normalised cylinder displacement signal at $\ured = 4.5$. We show $\cclys$ and $\cclys$ side by side in Fig. \ref{fig:tempAnalysisKVIV}a, present the temporal evolution of the phase lag $\phi$ in Fig. \ref{fig:tempAnalysisKVIV}b and show the temporal evolution of the instantaneous frequency of the lift coefficient signal in Fig. \ref{fig:tempAnalysisKVIV}c.
\end{figure}
