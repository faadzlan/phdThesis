...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.9\textwidth]{figs/yStrRMS1}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{figs/yStrFreq5}
...
\begin{figure}
  \centering
\includegraphics[width=0.8\textwidth]{figs/probe90YU10}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorx675}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorz675}
...
\begin{figure} \continuedfloat
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorx45}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorz45}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorx225}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorz225}
...
\begin{figure} \continuedfloat
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorx00}
  ...
  \begin{subfigure}[h]{1\textwidth}
    \centering
    \includegraphics[width=0.6\textwidth]{figs/vorz00}
...
The first part of this chapter investigated the amplitude/frequency responses of the pure cruciform and compared them to the experiment done in the open flow channel, and with experimental works of others in the literature. In doing so, this work found good agreement between the amplitude responses and observed fair agreement between the frequency responses. Then, the chapter proceeds with the demonstration of grid independency of the numerical solution. Through the GCI study, the fine mesh used for numerical data collection has been demonstrated to produce convergent results for $\ystr$, $\fstr$ and $\cl$.

% The discrepancy in the frequency responses are attributed to the high resolution of observation obtainable through the use of CFD, which is not obscured by random excitation frequencies present in experimental works.
...
In answering objective two, this chapter found that the existence of two dominant components in the lift signal of the pure cruciform explains the saturation of $\yrms$ in the amplitude response curve, wherein a significant amount energy from the freestream is lost due to the production of Karman vortices. If the loss can be eliminated, this thesis found that for the pure cruciform, the power output can potentially be improved by a factor of two to a factor of three depending on $\ured$. Computation of the phase lag between $\cl$ and $\ystr$ suggests the existence of five regimes of vibration of the pure cruciform, four for the steep angled-cruciforms, and three for the shallow-angled cruciforms.

%% Section Summary Part 2
In this section, the present author explored the amplitude/frequency response of steep-angled cruciforms, defined as a cruciform with angles $45 \leq \alpha (\si{\degree}) \leq 67.5$.
