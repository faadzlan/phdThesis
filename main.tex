...
\begin{figure} \continuedfloat
  ...
  \caption{The cruciform variations studied in this thesis (cont.)}\label{fig:cruciformLayouts}
...
\begin{figure} \continuedfloat
  ...
  \caption{The course, medium and fine mesh used in the grid independency study (cont.)} \label{fig:convergenceStudy}
